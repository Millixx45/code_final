...
**Datei:** `UNBOND_Breaking_Chains_replit2.html` (~5.000 Zeilen)
...
- Jedes Modul folgt dem Muster: **Story → Diagnose → Lösung → Übungen → Deep Dive**
...
→ section-modul1 … section-modul10 → section-glossar
```

### Referenzdokument
Lies `/home/user/workspace/unbond_gap_analyse.pplx.md` – dort findest du die vollständige Gap-Analyse mit allen 15 Lücken, Modulzuordnungen, Lernzielen, Disclaimern und konkreten Übungen.
...
4. **Kein Renumbering** — Modul 1-10 bleiben, Bonusmodule bekommen eigene IDs

---

## PHASE 1: Bestehende Kapitel anreichern (Priorität HOCH 🔴)
...
## PHASE 2: Neue Bonusmodule (nach section-modul10, vor section-glossar)
...
4. **Innerhalb Phase 1:** Beginne mit 1.1 (Modul 4 – Breadcrumbing), dann 1.2 (Modul 3), dann 1.3 (Modul 9 – 4 Unterkapitel), dann 1.4 (Modul 8), dann 1.5 (Modul 3 Ergänzungen), dann 1.6 (Kapitel 0)
5. **Teste nach jeder Phase** ob die Navigation funktioniert und die neuen Sections erreichbar sind
6. **Sprachstil:** Deutsch, warm aber professionell, Du-Ansprache (wie im Rest des Buchs). Story-Teile emotional und bildhaft. Diagnose-Teile sachlich mit Fachbegriffen. Übungen konkret und handlungsorientiert.
...
- [ ] Alle 15 Lücken aus der Gap-Analyse adressiert
- [ ] Phase 1: 6 bestehende Module um insgesamt ~12 neue Unterkapitel erweitert
- [ ] Phase 2: 2 neue Bonusmodule erstellt (Grief + Forensik)
...
- [ ] Jedes Unterkapitel enthält: Story, Diagnose, Lösung, mind. 1 Übung, Disclaimer
